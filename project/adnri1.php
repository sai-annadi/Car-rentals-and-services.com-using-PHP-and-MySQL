...
<link rel='stylesheet' type='text/css' href='css/style21.php' />
</head>
<body>
<pre>
...
<div class="f6">
<form action="requestnri.php">
<input type="submit" value="requested booking">
</form>
<form action="confirmnri.php">
<input type="submit" value="confirmed booking">
</form>
<form action="cancelnri.php">
<input type="submit" value="cancelled booking">
</form>
</div>
</body>
</html>