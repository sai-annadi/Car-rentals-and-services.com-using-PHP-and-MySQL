...
<div class="f2">
     <h2> CANCELLED CAR SERVICE BOOKINGS</h2>
     </div>
...
<div class="b7">
<form action="adservice5.php">
<input type="submit"  value="GIVE CAR TO THE STORE FOR SERVICE">
</form>
<form action="adservice6.php">
<input type="submit"  value="PICK UP FROM HOME">
</form>
</div>
