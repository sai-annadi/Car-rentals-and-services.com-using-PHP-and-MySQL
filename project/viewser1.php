...
$sql ="select * from carservice where bookstatus='$req'OR bookstatus='$re' AND name='$uname'";
...
echo "<td><form action='viewsetnr.php' method='post'><input type='submit'name='cancel' value='CANCEL'></form></td>";
echo "</tr>"; 
  }
