...
$sql ="select * from carrentalsnri where bookstatus='$req'OR bookstatus='$re' AND name='$uname'";
...
echo "<td><form action='viewentnr.php' method='post'><input type='submit'name='cancel' value='CANCEL'></form></td>";
