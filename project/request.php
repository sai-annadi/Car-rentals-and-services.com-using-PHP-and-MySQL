...
<body>
<div class="f2">
<h2>Requested car booking</h2>
</div>
<?php
$req='requested';
$conn=mysqli_connect("localhost","root","","carrentals") or die("failed:" . mysqli_connect_error());
$sql = mysqli_query($conn,"select * from carrentalbooking where bookstatus='$req'");
...
echo "<td><form action='req.php' method='post'><input type='submit' name='edit' value='edit'></form></td>";
echo "</tr>"; 
  }
