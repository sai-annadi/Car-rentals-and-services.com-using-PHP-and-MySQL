...
<div class="f2">
     ...
     <h2>View CAR SERVICE BOOKINGS</h2>
     </div>
...
$sql ="select * from carservicen where bookstatus='$req'OR bookstatus='$re' AND name='$uname'";
...
echo "<td><form action='viewsetnr1.php' method='post'><input type='submit'name='cancel' value='CANCEL'></form></td>";
echo "</tr>"; 
  }
