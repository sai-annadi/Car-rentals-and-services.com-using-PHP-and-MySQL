<html>
<head>
<link rel="stylesheet" type="text/css" href="css/style23.php">
</head>
</body>
<pre>
<div class="f2">

     <h2>View CANCELLATION CAR RENTAL BOOKINGS</h2>
     </div>
...
$uname=$_SESSION['username'];
 ...
 $sql ="select * from carrentalbooking where bookstatus='$req' AND name='$uname'";
